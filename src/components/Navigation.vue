  ...
  <nav class="fixed top-0 left-0 w-full z-50 px-8 py-6">
    <div class="max-w-7xl mx-auto flex justify-between items-center">
      <a href="/" class="flex flex-col leading-none">
        <span class="text-[36px] font-medium leading-[100%]">FABIAN</span>
        <span class="text-[36px] font-medium leading-[100%]">PAUL</span>
      </a>
      ...
      <div class="flex items-center gap-6">
        ...
        <button @click="toggleMenu" class="text-text-primary z-50 relative">
          <span class="sr-only">Menu</span>
          <div class="w-8 h-5 flex flex-col justify-between">
            <span class="w-full h-0.5 bg-current transform transition-transform duration-300" :class="{ 'rotate-45 translate-y-2': isMenuOpen }"></span>
            <span class="w-full h-0.5 bg-current transition-opacity duration-300" :class="{ 'opacity-0': isMenuOpen }"></span>
            <span class="w-full h-0.5 bg-current transform transition-transform duration-300" :class="{ '-rotate-45 -translate-y-2': isMenuOpen }"></span>
          </div>
        </button>
      </div>
